...
function drawSheep(){
   ...
   upplefthorn.textureNum = -2;
   if(g_normalOn) upplefthorn.textureNum = -3;
   ...
   upplefthorn.matrix.translate(-3.01, 7, -11.95);
	upplefthorn.normalMatrix.setInverseOf(upplefthorn.matrix).transpose();
   upplefthorn.renderfast();
   
   var upprighthorn = new Cube();
   upprighthorn.color = horn;
   upprighthorn.textureNum = -2;
   if(g_normalOn) upprighthorn.textureNum = -3;
   ...
   upprighthorn.matrix.translate(2.01, 7, -11.95);
	upprighthorn.normalMatrix.setInverseOf(upprighthorn.matrix).transpose();
   upprighthorn.renderfast();
